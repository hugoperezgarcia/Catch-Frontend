                ...
                <section className="bg-violet-600 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(202,182,255,1),rgba(255,255,255,0))] h-screen">
                    ...
                    <main className='flex justify-center items-center h-full'>
                        <div className="bg-white bg-opacity-80 backdrop-blur-lg p-8 rounded-lg shadow-md w-full max-w-md animate-flip-up animate-ease-in-out">
                            <h2 className="text-3xl font-titulo mb-6 text-center">Regístrate</h2>

                            <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                                <div>
                                    <label htmlFor={usernameId} className="block text-sm font-normal text-gray-700">Nombre de Usuario:</label>
                                ...
                                <div>
                                    <label htmlFor={repitePasswordId} className="block text-sm font-normal text-gray-700">Contraseña:</label>
                                ...
                                <div>
                                    <label htmlFor={passwordId} className="block text-sm font-normal text-gray-700">Repite la Contraseña:</label>
                                ...
                                <div>
                                    <label htmlFor={claveAdminId} className="block text-sm font-normal text-gray-700">Clave de administrador:</label>
                                ...
                                <button type="submit" className="w-full px-4 py-2 bg-amber-500/90 hover:bg-amber-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-normal rounded-md text-white">Registrar Cuenta</button>
