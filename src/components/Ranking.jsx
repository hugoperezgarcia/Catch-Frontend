  ...
  return (
    <>
      {loading ? (
        ...
        <main className="h-screen flex flex-col bg-violet-600 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(202,182,255,1),rgba(255,255,255,0))]">
          <header className="flex justify-between p-10 font-medium text-6xl text-white">
            ...
            <h1 className="bg-violet-300/80 rounded-full py-3 px-5 shadow-md">
              RANKING
            </h1>
            <button className="w-10" onClick={() => volver()}>
              <LogoHome />
            </button>
          </header>
            ...
            <div className="w-1/2 flex justify-center items-center">
              <div className="flex justify-center items-end space-x-0.5">
                <div className="flex flex-col items-center">
                  <p className="text-white text-2xl animate-bounce">
                    🥈{jugadores.length > 1 ? jugadores[1].nombre : <div />}
                  </p>
                ...
                <div className="flex flex-col items-center">
                  <p className="text-white text-3xl animate-bounce">
                    🏆{jugadores.length > 0 ? jugadores[0].nombre : <div />}
                  </p>
